...
namespace Misa\Accounting\Infrastructure\Ui\UsersBundle\DataFixtures\ORM;
 ...
 *
 * @package Misa\Accounting\Infrastructure\Ui\UsersBundle\DataFixtures\ORM
...
class LoadEmployeeData extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    ...
    public function load(ObjectManager $manager)
    {
         ...
         */
        $userAdmin = $manager->find('Misa\Accounting\Domain\User', '4d06bca6-017e-496b-97d8-dbb6d64dc4ed');
