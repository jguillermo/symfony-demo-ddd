 ...
 */
class Version20171025232347 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE provider_provider (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', source_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', contac_name VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_DA861D75953C1C61 (source_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE provider_product_providerproduct (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', provider_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', product_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', `range` SMALLINT NOT NULL, INDEX IDX_99F09853A53A8AA (provider_id), INDEX IDX_99F098534584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
